...
Padding(
  ...
  child: Column(children: [
    ...
    Center(child: Text("Enter your mail", style: TextStyle(color: Color(0xFFbbb0ff), fontSize: 18.0, fontWeight: FontWeight.w500),)),
                    ...
                    child: Container(
                      ...
                      child: Material(
                        ...
                        child: Container(
                          ...
                          child: Center(child: Text("Send Email", style: TextStyle(color: Colors.white, fontSize: 18.0, fontWeight: FontWeight.bold))),),
                      ),
                    ),
                  ),
                )
